 ...
 */
public class CreateProductDialogController implements Initializable {
    @FXML
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        image_selector.setOnAction(e -> {
            Stage stage = (Stage) name_field.getScene().getWindow();
            File file = PopUpWindows.ShowImageSelector(stage, "Choose Product's Image");
            if (file != null) {
                try (InputStream is = new FileInputStream(file)) {
                    image = is.readAllBytes();
                    image_label.setText("Image(" + file.getName() + ")");
        ...
        add_btn.setOnAction(e -> {
            ...
            if (PopUpWindows.ShowResult(ProductsDatabase.addProduct(product))) {
